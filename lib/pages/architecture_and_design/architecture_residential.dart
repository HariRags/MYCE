...
class ArchitectureResedential extends StatefulWidget {
  const ArchitectureResedential({Key? key}) : super(key: key);

  @override
  State<ArchitectureResedential> createState() => _ArchitectureResedentialState();
}

class _ArchitectureResedentialState extends State<ArchitectureResedential> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      const NavigationWidget(navigationItems: ['Architecture & Design', 'Architecture Design', 'Resedential Apartment']),
      Container(
