...
class InteriorIndustrial extends StatefulWidget {
  const InteriorIndustrial({Key? key}) : super(key: key);

  @override
  State<InteriorIndustrial> createState() => _InteriorIndustrialState();
}

class _InteriorIndustrialState extends State<InteriorIndustrial> {
  String auth_token="";
            ...
            builder: (context, state){
              return SafeArea(
                  child: Column(children: [
                    ...
                    const NavigationWidget(navigationItems: ['Architecture & Design', 'Interior Design', 'Industrial']),
                    Container(
