...
class StructureVilla extends StatefulWidget {
  const StructureVilla({Key? key}) : super(key: key);

  @override
  State<StructureVilla> createState() => _StructureVillaState();
}

class _StructureVillaState extends State<StructureVilla> {
  String auth_token="";
            ...
            builder: (context, state){
              return SafeArea(
                  child: Column(children: [
                    ...
                    const NavigationWidget(navigationItems: ['Architecture & Design', 'Structure Design', 'Villa']),
                    Container(
