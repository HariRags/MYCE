...
class InteriorResidential extends StatefulWidget {
  const InteriorResidential({Key? key}) : super(key: key);

  @override
  State<InteriorResidential> createState() => _InteriorResidentialState();
}

class _InteriorResidentialState extends State<InteriorResidential> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      const NavigationWidget(navigationItems: ['Architecture & Design', 'Interior Design', 'Residential Apartment']),
      Container(
