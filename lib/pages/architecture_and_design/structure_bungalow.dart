...
class StructureBungalow extends StatefulWidget {
  const StructureBungalow({Key? key}) : super(key: key);

  @override
  State<StructureBungalow> createState() => _StructureBungalowState();
}

class _StructureBungalowState extends State<StructureBungalow> {
  String auth_token="";
            ...
            builder: (context, state){
              return SafeArea(
                  child: Column(children: [
                    ...
                    const NavigationWidget(navigationItems: ['Architecture & Design', 'Structure Design', 'Bungalow']),
                    Container(
