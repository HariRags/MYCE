...
class InteriorBungalow extends StatefulWidget {
  const InteriorBungalow({Key? key}) : super(key: key);

  @override
  State<InteriorBungalow> createState() => _InteriorBungalowState();
}

class _InteriorBungalowState extends State<InteriorBungalow> {
  String auth_token="";
            ...
            builder: (context, state){
              return SafeArea(
                  child: Column(children: [
                    ...
                    const NavigationWidget(navigationItems: ['Architecture & Design', 'Interior Design', 'Bungalow']),
                    Container(
