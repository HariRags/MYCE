...
class ArchitectureIndustrial extends StatefulWidget {
  const ArchitectureIndustrial({Key? key}) : super(key: key);

  @override
  State<ArchitectureIndustrial> createState() => _ArchitectureIndustrialState();
}

class _ArchitectureIndustrialState extends State<ArchitectureIndustrial> {
  String auth_token="";
            ...
            builder: (context, state){
              return SafeArea(
                  child: Column(children: [
                    ...
                    const NavigationWidget(navigationItems: ['Architecture & Design', 'Architecture Design', 'Industrial']),
                    Container(
