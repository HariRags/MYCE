...
class InteriorCommercial extends StatefulWidget {
  const InteriorCommercial({Key? key}) : super(key: key);

  @override
  State<InteriorCommercial> createState() => _InteriorCommercialState();
}

class _InteriorCommercialState extends State<InteriorCommercial> {
  String auth_token="";
            ...
            builder: (context, state){
              return SafeArea(
                  child: Column(children: [
                    ...
                    const NavigationWidget(navigationItems: ['Architecture & Design', 'Interior Design', 'Commercial']),
                    Container(
