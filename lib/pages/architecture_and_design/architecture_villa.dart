...
class ArchitectureVilla extends StatefulWidget {
  const ArchitectureVilla({Key? key}) : super(key: key);

  @override
  State<ArchitectureVilla> createState() => _ArchitectureVillaState();
}

class _ArchitectureVillaState extends State<ArchitectureVilla> {
  String auth_token="";
            ...
            builder: (context, state){
              return SafeArea(
                  child: Column(children: [
                    ...
                    const NavigationWidget(navigationItems: ['Architecture & Design', 'Architecture Design', 'Villa']),
                    Container(
