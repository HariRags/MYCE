...
class StructureIndustrial extends StatefulWidget {
  const StructureIndustrial({Key? key}) : super(key: key);

  @override
  State<StructureIndustrial> createState() => _StructureIndustrialState();
}

class _StructureIndustrialState extends State<StructureIndustrial> {
  String auth_token="";
  late StructureBloc _structureBloc;
  @override
  void initState() {
    super.initState();
    // Access houseBloc from the context here
    final structureBloc = BlocProvider.of<StructureBloc>(context);
    auth_token = structureBloc.authToken;
    _structureBloc = StructureBloc(auth_token);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        body: BlocProvider(
          ...
          child: BlocConsumer<StructureBloc,StructureState>(
    ...
    listener: (context, state) {
      ...
      if (state is StructureSubmittedState) {
      ...
      } else if (state is StructureErrorState) {
            ...
            builder: (context, state){
              return SafeArea(
                  child: Column(children: [
                    ...
                    const NavigationWidget(navigationItems: ['Architecture & Design', 'Structure Design', 'Industrial']),
                    Container(
