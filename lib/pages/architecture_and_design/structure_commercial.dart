...
class StructureCommercial extends StatefulWidget {
  const StructureCommercial({Key? key}) : super(key: key);

  @override
  State<StructureCommercial> createState() => _StructureCommercialState();
}

class _StructureCommercialState extends State<StructureCommercial> {
  String auth_token="";
            ...
            builder: (context, state){
              return SafeArea(
                  child: Column(children: [
                    ...
                    const NavigationWidget(navigationItems: ['Architecture & Design', 'Structure Design', 'Commercial']),
                    Container(
