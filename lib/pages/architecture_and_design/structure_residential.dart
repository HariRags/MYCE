...
class StructureResidential extends StatefulWidget {
  const StructureResidential({Key? key}) : super(key: key);

  @override
  State<StructureResidential> createState() => _StructureResidentialState();
}

class _StructureResidentialState extends State<StructureResidential> {
  String auth_token="";
            ...
            builder: (context, state){
              return SafeArea(
                  child: Column(children: [
                    ...
                    const NavigationWidget(navigationItems: ['Architecture & Design', 'Structure Design', 'Residential Apartment']),
                    Container(
