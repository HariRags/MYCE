...
class ArchitectureBungalow extends StatefulWidget {
  const ArchitectureBungalow({Key? key}) : super(key: key);

  @override
  State<ArchitectureBungalow> createState() => _ArchitectureBungalowState();
}

class _ArchitectureBungalowState extends State<ArchitectureBungalow> {
  String auth_token="";
            ...
            builder: (context, state){
              return SafeArea(
                  child: Column(children: [
                    ...
                    const NavigationWidget(navigationItems: ['Architecture & Design', 'Architecture Design', 'Bungalow']),
                    Container(
