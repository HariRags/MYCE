...
class InteriorVilla extends StatefulWidget {
  const InteriorVilla({Key? key}) : super(key: key);

  @override
  State<InteriorVilla> createState() => _InteriorVillaState();
}

class _InteriorVillaState extends State<InteriorVilla> {
  String auth_token="";
            ...
            builder: (context, state){
              return SafeArea(
                  child: Column(children: [
                    ...
                    const NavigationWidget(navigationItems: ['Architecture & Design', 'Interior Design', 'Villa']),
                    Container(
