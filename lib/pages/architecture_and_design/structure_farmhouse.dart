...
class StructureFarmhouse extends StatefulWidget {
  const StructureFarmhouse({Key? key}) : super(key: key);

  @override
  State<StructureFarmhouse> createState() => _StructureFarmhouseState();
}

class _StructureFarmhouseState extends State<StructureFarmhouse> {
  String auth_token="";
            ...
            builder: (context, state){
              return SafeArea(
                  child: Column(children: [
                    ...
                    const NavigationWidget(navigationItems: ['Architecture & Design', 'Structure Design', 'Farmhouse']),
                    Container(
