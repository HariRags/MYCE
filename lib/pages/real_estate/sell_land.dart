...
import 'dart:io';
class SellLand extends StatefulWidget {
  
  const SellLand({Key? key}) : super(key: key);

  @override
  State<SellLand> createState() => _SellLandState();
}

class _SellLandState extends State<SellLand> {
  String auth_token="";
            ...
            builder: (context,state){
              return SafeArea(
                  child: Column(children: [
                    ...
                    const NavigationWidget(navigationItems: ['Real Estate', 'Sell', 'Land']),
                    Container(
