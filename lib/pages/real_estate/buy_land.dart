...
class BuyLand extends StatefulWidget {
  final String? authToken;
  const BuyLand({Key? key, required this.authToken}) : super(key: key);

  @override
  State<BuyLand> createState() => _BuyLandState();
}

class _BuyLandState extends State<BuyLand> {
  String auth_token="";
            ...
            builder: (context,state){
              return SafeArea(
                  child: Column(children: [
                    ...
                    const NavigationWidget(navigationItems: ['Real Estate', 'Buy', 'Land']),
                    Container(
