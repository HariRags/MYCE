...
class PoolEquipment extends StatefulWidget {
  final String? authToken;
  const PoolEquipment({Key? key,required this.authToken}) : super(key: key);

  @override
  State<PoolEquipment> createState() => _PoolEquipmentState();
}
