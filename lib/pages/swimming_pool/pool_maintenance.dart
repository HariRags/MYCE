...
class PoolMaintanence extends StatefulWidget {
  final String? authToken;
  const PoolMaintanence({Key? key,required this.authToken}) : super(key: key);

  @override
  State<PoolMaintanence> createState() => _PoolMaintanenceState();
}

class _PoolMaintanenceState extends State<PoolMaintanence> {
  String auth_token="";
            ...
            builder: (context,state){
              return SafeArea(
                  child: Column(children: [
                    ...
                    const NavigationWidget(navigationItems: ['Swimming Pool', 'Maintanence']),
                    Container(
