...
class PoolMaintenance extends StatefulWidget {
  const PoolMaintenance({Key? key}) : super(key: key);

  @override
  State<PoolMaintenance> createState() => _PoolMaintenanceState();
}

class _PoolMaintenanceState extends State<PoolMaintenance> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      const NavigationWidget(navigationItems: ['Swimming Pool', 'Maintenance']),
      Container(
