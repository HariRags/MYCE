...
class CommercialWarehouse extends StatefulWidget {
  const CommercialWarehouse({Key? key}) : super(key: key);

  @override
  State<CommercialWarehouse> createState() => _CommercialWarehouseState();
}

class _CommercialWarehouseState extends State<CommercialWarehouse> {
  String auth_token = "";
            ...
            builder: (context,state){
              return SafeArea(
                  child: Column(children: [
                    ...
                    const NavigationWidget(navigationItems: ['Execution', 'Commercial', 'Warehouses']),
                    Container(
